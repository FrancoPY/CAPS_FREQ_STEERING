    ...
    for steering_angle = steeringAngles
        ...
        for frame = 1:nFrames
            ...
            for sourceStrength = sourceStrengths
                ...
                fprintf('  [f0=%dMHz][angulo %d][frame %d] %dkPa\n', ...
                    round(f0/1e6), steering_angle, frame, round(sourceStrength / 1e3));
                ...
                save(outName, 'rfPrebf', 'fs', 'c0', 'offset_base', 'f0', 'steering_angle');
